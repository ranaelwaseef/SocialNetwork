...
<body>
  ...
  <nav>
    ...
    <?php
        ...
        $MYID=$_SESSION['ID'];
           $querymsg = "SELECT * FROM messages WHERE To_ID= $MYID  order By Date1 Desc";
...
while($row = mysqli_fetch_array($resultrequest1, MYSQLI_ASSOC))
    ...
    ?>
        ...
        <?php
              ...
              <div class="reqlink">
                  <?php
    echo "<a href='Profile.php?id=$rows[User_ID]'>".$rows['FirstName']. ' '.$rows['LastName']. " </a> </br>";?></div>
    ...
    {?>
        ...
        <?php
        echo $row['body'] ." </br/>";?></div>
        
            <div class="datemsg">    <?php   echo "<br>"; echo $row['Date1'];
                ?> </div> 
 <?php echo "<br>";
 echo "<br>";
